...
const Contact = () => {
  ...
  return (
    <section id="contact" className="min-h-screen flex items-center justify-center py-16 sm:py-20 md:py-24 scroll-mt-[0vh]">
      <div className="container mx-auto px-4 sm:px-8 xl:px-24 max-w-6xl">
        <motion.div
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-[#CBD5E1]">Asheville, NC</p>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-[#CBD5E1] mb-2">Name</label>
                <input
                  type="text"
                  id="name"
                  value={formData.name}
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-[#CBD5E1] mb-2">Email</label>
                <input
                  type="email"
                  id="email"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-[#CBD5E1] mb-2">Message</label>
                <textarea
                  id="message"
                  rows={4}
